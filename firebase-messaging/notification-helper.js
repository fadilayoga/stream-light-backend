                    ...
                    if (err) {
                        ...
                        if (result.ldr < 100) {
                            if (lighting.status.light) {
                                if (!result.location) {
                                    this.getOneLightingLog(lighting._id).then(logWithlastValidLocation => {
                                        this.updateLightingStatus(logWithlastValidLocation, callback).then(result => {
                                            console.log(result)
                                        }).catch(err => {
                                            console.log(err)
                                        })
                                    ...
                                    this.updateLightingStatus(result, callback).then(result => {
                                        console.log(result)
                                    }).catch(err => {
                                        console.log(err)
                                    })
            ...
            dbConnect
                .findOneAndUpdate(filter, update, (err, result) => {
                    if (err) {
                        ...
                        this.storeProblemLog(logs, callback).then(result => {
                            console.log(result)
                        }).catch(err => {
                            console.log(err)
                        })
